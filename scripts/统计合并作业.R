...
# 读取
asv_table <- read.csv("temperary_data/relative_table_only.csv")
taxonomy_table <- read.csv("temperary_data/taxonomy_table.csv")
...
write.table(merged, "temperary_data/relative_table_tax.csv", sep = "\t", quote = F)
